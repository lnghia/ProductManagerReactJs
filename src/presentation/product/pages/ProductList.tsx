...
function ProductList() {
  ...
  useEffect(() => {
      fetchProducts(currPage - 1, pageSize).then(res => {
  ...
  return (
    <div className="container">
      ...
      <div className="w-100 header-btn">
        ...
        <Button variant="contained" onClick={openDialogCreateProduct} color="secondary">Add Product</Button>
        ...
        <CreateProduct isOpen={openCreateProductDialog} closeDialog={closeDialogCreateProduct} />
      </div>
